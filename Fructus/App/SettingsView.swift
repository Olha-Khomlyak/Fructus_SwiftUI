            ...
            ScrollView(.vertical, showsIndicators: false){
                VStack(spacing:20){
                    ...
                    GroupBox(label: SettingsLabelView(labelText: "Application", labelImage: "apps.iphone")) {
                        ...
                        SettingsRowView(label: "Designer", value: "Robert Petras")
                        SettingsRowView(label: "Compatibility", value: "iOS 15" )
                        ...
                        SettingsRowView(label: "SwiftUI", value: "2.0")
                        SettingsRowView(label: "Version", value: "1.1.0")
